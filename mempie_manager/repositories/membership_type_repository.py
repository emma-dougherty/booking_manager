...
def save(membership_type):
    sql = "INSERT INTO membership_types (name, benefits) VALUES (%s, %s) RETURNING id"
    values = [membership_type.name, membership_type.benefits]
...
def select_all():
    ...
    for result in results:
        membership_type = MembershipType(result["name"], result["benefits"], result["id"])
